...
// methods (`.static`, `.Router`, `.json`, ...). The runners themselves
// only call `express()` here, but typing as the full module keeps the
// alias name (`ExpressModule`) aligned family-wide and ready to absorb
// future namespace usage without another rename round.
//
